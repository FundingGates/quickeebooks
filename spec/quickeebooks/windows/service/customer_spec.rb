...
describe "Quickeebooks::Windows::Service::Customer" do
  ...
  describe '#create' do
    it "raises an InvalidModelException if the given customer is missing a name" do
    ...
    it "raises an InvalidModelException if the given customer is missing type_of" do
      customer = Quickeebooks::Windows::Model::Customer.new
      service = Quickeebooks::Windows::Service::Customer.new
      service.access_token = @oauth
      service.realm_id = @realm_id
    ...
    it "raises an InvalidModelException if the given customer has an invalid name" do
      customer = Quickeebooks::Windows::Model::Customer.new
      service = Quickeebooks::Windows::Service::Customer.new
      service.access_token = @oauth
      service.realm_id = @realm_id
    ...
    it "raises an InvalidModelException if the given customer is missing an address" do
      customer = Quickeebooks::Windows::Model::Customer.new
      service = Quickeebooks::Windows::Service::Customer.new
      service.access_token = @oauth
      service.realm_id = @realm_id
    ...
    it "raises an InvalidModelException if the given customer has an invalid email" do
      customer = Quickeebooks::Windows::Model::Customer.new
      service = Quickeebooks::Windows::Service::Customer.new
      service.access_token = @oauth
      service.realm_id = @realm_id
  ...
  describe '#update' do
    ...
    it "accepts a Customer object returned by #fetch_by_id"

    it "raises an InvalidModelException given an invalid customer"
  end
end
